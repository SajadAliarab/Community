  ...
  return (
    <div className="h-screen flex justify-center items-start mt-20 md:mr-40">
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-sm p-8 space-y-6  rounded shadow-2xl">
        ...
        <Link
         href="/register"
          className=" mt-5 sm:ml-10 text-black bg-secondary-500 hover:bg-secondary-800 focus:ring-4 focus:outline-none focus:ring-secondary-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
          Join
        </Link>
